...
import studentPic from "./../../assets/avatar.png"


const StudentInfo = () => {
    const [studentData, setStudentData] = useState({ classOne: [], classTwo: [] });
    ...
    console.log(studentData.classOne);
    return (
                        ...
                        <tbody>
                            ...
                            {studentData.classOne && (
                                <>
                                    ...
                                    {studentData.classOne.map((student, index) => (
                            ...
                            {studentData.classTwo && (
                                <>
                                    ...
                                    {studentData.classTwo.map((student, index) => (
                                        <tr key={index} className="border-b border-[#7ECEB529]">
                                            <td className="p-5 text-sm md:text-xl">{index + 1}</td>
                                            <td className="p-5 text-sm md:text-xl">
                                                <div className="flex space-x-3 items-center">
